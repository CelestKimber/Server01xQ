...
exports.commands = {
	...
	shop: function (target, room, user) {
		...
		this.sendReplyBox(
			'<center><font color="#3E67A8"><b></b></font><p><font color="#ff0000"><b> Tienda del Servidor</b></font></p><table style="background: #A600FF; border: 2px solid #3e67a8 ; padding: 2px ; border-radius: 5px" border="5" cellspacing="5" cellpadding="5"><tbody>' +
			'<tr style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ff00"><th>Articulo</th><th>Descripcion</th><th>Precio</th></tr>' +
			'<tr><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00ff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy chatroom"> <b>Sala</b> </button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff">Compra una Sala de chat. Será pública o privada en función del motivo de su compra. Si se detecta spam de comandos, su sala será borrada.</td><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>5000</center></td></tr>' +
			'<tr> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505 ; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00ff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy customtc"><b>Custom TC</b></button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff">Compra una Tarjeta de Entrenador personalizada. Contactar con un administrador para su creacion.</td>  <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>4000</center></td></tr>' +
			'<tr><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505 ; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00ff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy Customavatar"><b>Custom Avatar</b></button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff">Compra un avatar personalizado. Preferiblemente debe ser una imagen de pequeñas dimensiones y acorde a las reglas del servidor (80x80). Contactar con un Admin para obtener este artículo.</td>  <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>3000</center></td></tr>' +
			'<tr><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505 ; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00ff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy Icon"><b>Icon</b></button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff">Compras el derecho de usar un icon personalizado el cual estará al lado de tu nick en la lista de users en cinco salas (Lobby y otras 4 que elijas), tiene que tener un tamaño de 32x32. Contacta a un administrador para obtenerlo.</td>  <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>2000</center></td></tr>' +
			'<tr><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505 ; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00fff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy TC"><b>TC</b></button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"> Compra una Tarjeta de entrenador básica. Con una Imagen modificable con /tcimage y una frase de entrenador modificable con /tcphrase.</td>  <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>1500</center></td></tr>  ' +
			'<tr><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505 ; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00ff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy Avatar"><b>Avatar</b></button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"> Si ya tienes un avatar personalizado. Puedes cambiarlo por otro diferente.</td>  <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>1000</center></td></tr>' +
			'<tr><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505 ; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00ff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy symbol"><b>Simbolo</b></button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"> Compra el acceso al comado /customsymbol que permite elegir un símbolo (excepto staff) para aparecer en lo alto de la lista de usuarios.</td>  <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>1000</center></td></tr>' +
			'<tr><td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505 ; color: #ffffff"><button style="color: #00ff00 ; text-align: center ; border: 1px solid #00ff00 ; border-right-color: #00ff00 ; border-left-color: #00ff00 ; background: -webkit-linear-gradient(#90ee90 , #00ff37) ; background: -o-linear-gradient(#90ee90 , #a600ff) ; background: linear-gradient(#000 , #000 , #000) ; box-shadow: 1px 0px 2px rgba(0 , 0 , 0 , 0.2) , -1px 0px 2px rgba(0 , 0 , 0 , 0.2) , inset 0 1px 1px rgba(255 , 255 , 255 , 0.5) ; width: 85px ; height: 35px" name="send" value="/buy sprite"><b>Sprite</b></button></td> <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"> Añade la imagen de un Pokemon a tu TC Básica. Máximo 6. Se pueden cambiar los pokemon con el comando /tcpokemon.</td>  <td style="border-radius: 5px ; border: 1px solid #7296d3 ; background: #050505; color: #00ffff"><center>60</center></td></tr>' +
			'</tbody></table><table><tbody><tr><td> <center> <font color="#FF00FF"> <b><details class="keyboard-alpha" style="vertical-align: top ; line-height: 2.0; margin: auto"> <summary style="cursor: pointer">Informacion</summary>Puedes comprar cualquier articulo de esta tienda dando click en el botón correspondiente o con el comando /buy (articulo).' +
			'</br><br>Te recomendamos leer la información o descripción de cada articulo ya que no aceptamos devoluciones, si tienes una duda sobre un artículo, contacta al staff.</details> </b></font></center> </td></tr></tbody> </table>' +
			'</center>'
		);
	},
